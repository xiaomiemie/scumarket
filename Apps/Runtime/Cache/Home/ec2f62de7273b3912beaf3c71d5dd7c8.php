...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/scumarket/Apps/Home/Public/css/personal/personal.css">
  <script type="text/javascript" src="/scumarket/Apps/Home/Public/framework/require.js" data-main='/scumarket/Apps/Home/Public/js/personalCenter/personalapp'></script>
</head>
<body>
      ...
      <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="updateGood">
          <form class="form-horizontal" name="updateGoods" enctype='multipart/form-data'>
            ...
            <div class="form-group ">
              <label class="col-sm-2 control-label">图片上传(图片均&lt;1M。<a href=" <?php echo U('pic/pic');?>">点击修改图片</a>)</label>
              <div class="col-sm-10">
...
<div class="loading">
  <img src="/scumarket/Apps/Home/Public/image/loading2.jpg">
</div>
<!-- 头部信息 -->
  <header class="header">
  <span class="logo-name"><img src="/scumarket/Apps/Home/Public/image/logoheader.png" alt="川大跳槽市场"/><a target="_blank" href="<?php echo U('Index/index');?>">川大跳蚤市场</a></span>
    <ul class='nav-ul'>
